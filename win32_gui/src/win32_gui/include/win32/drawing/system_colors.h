...
namespace win32 {
  ...
  /// @remarks Better performance is achieved by using the properties of the win32::system_pens or win32::system_brushes classes rather than creating a new pen or brush based on a value from win32::system_colors. For example, if you wanted to get a brush for the face color of a 3-D element, use the SystemBrushes.Control property because it gets a brush that already exists, whereas calling the SolidBrush.#ctor(xtd::drawing::color) constructor with a parameter value of system_colors::Control will create a new brush.
    ...
    public:
      ...
      static win32::drawing::color accent();
      ...
      static win32::drawing::color accent_text();
      ...
      static win32::drawing::color active_border();
      ...
      static win32::drawing::color active_caption();
      ...
      static win32::drawing::color active_caption_text();
      ...
      static win32::drawing::color app_workspace();
      ...
      static win32::drawing::color button_face();
      ...
      static win32::drawing::color button_highlight();
      ...
      static win32::drawing::color button_shadow();

      /// @brief Gets a xtd::drawing::color structure that is the face color of a 3-D element.
      /// @return A xtd::drawing::color that is the face color of a 3-D element.
      static win32::drawing::color control();

      /// @brief Gets a xtd::drawing::color structure that is the shadow color of a 3-D element.
      /// @return A xtd::drawing::color that is the shadow color of a 3-D element.
      /// @remarks This color is applied to parts of a 3-D element that face away from the light source.
      static win32::drawing::color control_dark();
      ...
      static win32::drawing::color control_dark_dark();
      ...
      static win32::drawing::color control_text();
      ...
      static win32::drawing::color desktop();
      ...
      static win32::drawing::color gradient_active_caption();
      ...
      static win32::drawing::color gradient_inactive_caption();
      ...
      static win32::drawing::color gray_text();
      ...
      static win32::drawing::color highlight();
      ...
      static win32::drawing::color highlight_text();
      ...
      static win32::drawing::color hot_track();
      ...
      static win32::drawing::color inactive_border();
      ...
      static win32::drawing::color inactive_caption();
      ...
      static win32::drawing::color inactive_caption_text();
      ...
      static win32::drawing::color info();
      ...
      static win32::drawing::color info_text();
      ...
      static win32::drawing::color menu();
      ...
      static win32::drawing::color menu_bar();
      ...
      static win32::drawing::color menu_highlight();
      ...
      static win32::drawing::color menu_text();
      ...
      static win32::drawing::color scroll_bar();
      ...
      static win32::drawing::color text_box();
      ...
      static win32::drawing::color text_box_text();
      ...
      static win32::drawing::color window();
      ...
      static win32::drawing::color window_frame();
      ...
      static win32::drawing::color window_text();
      /// @}
    };
  }
}